...
const NOTE_RANGE_SLIDER_CLASS =
  ...
  "[&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb] [&::-webkit-slider-thumb]:h-3.5 [&::-webkit-slider-thumb]:w-3.5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:bg-[#3b82f6] [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-[0_0_6px_rgba(59,130,246,0.55)] " +
      ...
      <div className="relative mx-4 w-full max-w-lg max-h-[85vh] overflow-hidden rounded-xl border border-[#1e293b] bg-[#0f1218] shadow-2xl animate-fade-in">
        ...
        <div className="max-h-[calc(85vh-56px)] space-y-8 overflow-y-auto px-5 py-6">
          ...
          {noteRange && instrumentInfo && (
            <section className="space-y-4">
              <div className="flex items-start justify-between gap-4">
                <h3 className="text-[14px] font-semibold uppercase tracking-wider text-gray-300">
                  Note Range
                </h3>
                <button
                  type="button"
                  onClick={handleResetNoteRange}
                  className="shrink-0 text-xs font-medium text-[#3b82f6] transition-colors hover:text-blue-400"
                >
                  기본값 복원
                </button>
              </div>
          ...
          <section className="space-y-4">
            ...
            <p className="text-xs leading-relaxed text-gray-500">
              생성되는 음표의 양을 조절합니다. 낮을수록 단조롭고, 높을수록
              음표가 많아집니다.
            </p>
